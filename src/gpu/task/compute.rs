...
use wgpu::{CommandEncoderDescriptor, ComputePipelineDescriptor};
...
#[pollster::test]
async fn test_computetask_add_one() {
    ...
    let shader_path = "src/gpu/task/compute.wgsl";
    let task = crate::gpu::task::compute::ComputeTask::new(
        backend.clone(),
        shader_path,
